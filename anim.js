...
var lyricsData = [
  ...
  { text: "Solitario antes de que el sol llorara(fe", time: 27 },
  ...
  { text: "Donde estoy ahora? No sé por qué", time: 169 },
  { text: "Lindas mariposas en mis manos", time: 176 },
  { text: "Demasiada luz para el crepúsculo", time: 183 },
  { text: "Y la luna para las flores", time: 188 },
  { text: "Amar.", time: 140 },
  { text: "TE AMO MARIORI.", time: 195 }
];
...
document.addEventListener("DOMContentLoaded", function() {
  ...
  setTimeout(() => {
    ...
    }, 2000); // Espera la transición antes de mostrar la segunda imagen
  }, 5000); // Ahora la primera imagen dura 5 segundos en vez de 15
});